...
[![Latest Stable Version](https://poser.pugx.org/wdna/users-roles/v/stable)](https://packagist.org/packages/wdna/users-roles) [![Total Downloads](https://poser.pugx.org/wdna/users-roles/downloads)](https://packagist.org/packages/wdna/users-roles)

[![Join the chat at https://gitter.im/wdna/users-roles](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/wdna/users-roles?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
...
Run `composer require wdna/users-roles 4.*`
