...
namespace wdna\ApiGuard\Http\Middleware;

use Carbon\Carbon;
use wdna\ApiGuard\Events\ApiKeyAuthenticated;
use wdna\ApiGuard\Models\Device;
use Closure;
...
class AuthenticateApiKey
{
    ...
    public function handle($request, Closure $next, $guard = null)
    {
        ...
        $apiKey = app(config('apiguard.models.api_key', 'wdna\ApiGuard\Models\ApiKey'))->where('key', $apiKeyValue)
            ->first();
